...
exports.createMajor = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to create major", details: error.message });
  }
};
exports.getallMajor = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to fetch majors", details: error.message });
  }
};
exports.updateMajor = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({
        message: `Major with ID ${id} has been updated successfully`,
        updatedMajor,
      });
  } catch (error) {
    ...
    res
      .status(500)
      .json({ error: "Unable to update major", details: error.message });
  }
};
exports.deleteMajor = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: `Major with ID ${id} has been deleted successfully` });
  } catch (error) {
    console.error("Error deleting major:", error.message, error.stack);
    res
      .status(500)
      .json({ error: "Unable to delete major", details: error.message });
  }
};
...
exports.createCategory = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to create category", details: error.message });
  }
};
exports.getAllCategories = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to retrieve categories", details: error.message });
  }
};
exports.updateCategory = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to update category", details: error.message });
  }
};
exports.deleteCategory = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to delete category", details: error.message });
  }
};
...
exports.createGroup = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to create group", details: error.message });
  }
};
exports.getAllGroups = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to retrieve groups", details: error.message });
  }
};
exports.updateGroup = async (req, res) => {
  ...
  try {
    ...
    if (!existingCategory) {
      return res
        .status(400)
        .json({ error: `Category with ID ${group.categoryId} does not exist` });
    }
    ...
    res
      .status(500)
      .json({ error: "Unable to update group", details: error.message });
  }
};
exports.deleteGroup = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: `Group with ID ${id} has been deleted` });
  } catch (error) {
    console.error("Error deleting group:", error.message, error.stack);
    res
      .status(500)
      .json({ error: "Unable to delete group", details: error.message });
  }
};
...
exports.createCourse = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to create course", details: error.message });
  }
};
exports.getAllCourses = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to retrieve courses", details: error.message });
  }
};
exports.updateCourse = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Unable to update course", details: error.message });
  }
};
exports.deleteCourse = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: `Course with ID ${id} has been deleted` });
  } catch (error) {
    console.error("Error deleting course:", error.message, error.stack);
    res
      .status(500)
      .json({ error: "Unable to delete course", details: error.message });
  }
};
